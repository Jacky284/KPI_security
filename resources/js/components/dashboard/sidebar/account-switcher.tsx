...
import { BadgeCheck, Bell, Check, CreditCard, LogOut, User } from "lucide-react";
  ...
  return (
    <DropdownMenu>
      <DropdownMenuTrigger asChild>
        <button className="flex items-center justify-center size-8 rounded-full border bg-background hover:bg-muted transition-colors cursor-pointer focus:outline-none">
